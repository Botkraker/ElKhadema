...
public class CVgenerator {
	public static void Generate(Person person,String path,List<Competance> comp,List<Experience> experience) throws IOException {
       ...
       // c1.add(new Paragraph("Redford & Sons, Boston, MA  /  September 2018 - Present").setFontSize(11));
        ...
        comp.forEach(t -> {c2.add(new ListItem(t.getTitre())).setFontSize(11);}) ;
